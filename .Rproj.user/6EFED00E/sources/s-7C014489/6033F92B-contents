centrism_css <- list(
  ...
  ".inverse" = list("background-image" = "url(https://clanfear.github.io/centrism_socsem/slides/img/UWSocBG1_white.svg)"),
...
mono_accent(base_color = "#342c5c",
            ...
            extra_css = centrism_css,
            title_slide_background_image = "https://clanfear.github.io/centrism_socsem/slides/img/title_slide_img.png",
            title_slide_background_position = "bottom",
            title_slide_background_size = "contain",
            background_image = "https://clanfear.github.io/centrism_socsem/slides/img/UWSocBG1.svg"
)