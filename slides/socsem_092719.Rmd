...
* *It is not consistently related to any policy positions.*
...
For bipartisan compromise centrism to be equivalent to electorate centrism, the positions of the parties would need to be centered over the preferences of their electorates. If these were true, the position of the more economically conservative party should establish a lower bound on the minimum wage. In reality, the current minimum wage is drastically below the median preference of the the Republican electorate.
...
* Use of centrism may constrain political debate.
]
