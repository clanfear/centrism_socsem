...
ggplot(typology_df, aes(x=x_loc, y=y_loc, label = label)) + 
  ...
  geom_circle(aes(x0 = x_loc, y0 = y_loc, r = radius, fill = party),
    ...
    geom_text(nudge_x = 0.01, nudge_y = -0.01, family = "Quattrocento", hjust=0, vjust=1) + 
  ...
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        legend.position = "none",
        axis.text = element_blank(), axis.title = element_text(size = rel(1.4)))
